...
import 'package:zikirdua/screens/dua_detail.dart';
...
class _DuaListState extends State<DuaList> {
  ...
  Future<List<dynamic>> _loadData() async {
    String jsonString = await rootBundle.loadString('json/dua.json');
        ...
        child: Stack(
          children: [
            ...
            themeChange.darkTheme
                ? Flare(
                    color: themeChange.darkTheme ? flare : green,
